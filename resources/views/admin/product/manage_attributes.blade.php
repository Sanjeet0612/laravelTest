...
@section('content')
    ...
    <thead>
        <tr>
            ...
            <th scope="col" class="text-center">Attribute Value</th>
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="form-switch switch-primary d-flex align-items-center justify-content-center">
                        <input class="form-check-input"
                               type="checkbox"
                               role="switch"
                               @if($attr->status==1) checked @endif>
                    </div>
                </td>
                ...
                <td class="text-center">
                    <div class="d-flex align-items-center gap-10 justify-content-center">
                        ...
                        <a href="{{ route('admin.edit_attribute',$attr->id) }}"
        ...
        <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
            <div class="modal-content radius-16 bg-base">
                <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Attributes </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                
                <div class="modal-body p-24">
                    <form action="{{route('admin.attributes')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-6 mb-20">
                                <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Category Name </label>
                                <select name="category_id" onchange="return getSubcat(this.value)" class="form-control radius-8 form-select">
                            ...
                            <div class="col-6 mb-20">
                                <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Sub Category </label>
                                <select name="sub_category_id" id="sub_category_id" class="form-control radius-8 form-select">
                                    <option value="">-- Select Subcategory --</option>
                                </select>
                            </div>

                            <div class="col-6 mb-20">
                                <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Attribute Name:</label>
                                <input type="text" name="name" class="form-control radius-8" placeholder="e.g., Size, Color">
                            </div>

                            <div class="col-6 mb-20">
                            <label for="values" class="form-label fw-semibold text-primary-light text-sm mb-8">Values (comma separated):</label>
                            <input type="text" name="values"  class="form-control radius-8" placeholder="Small, Medium, Large">
                             </div>
            ...
            <div class="modal-content radius-16 bg-base">
                ...
                <div class="modal-body p-24">
                    <form action="{{route('admin.update_category')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-6 mb-20">
                                <label for="editname" class="form-label fw-semibold text-primary-light text-sm mb-8">Category Name </label>
                                <input type="text" class="form-control radius-8" id="editcategory" name="category" value=""  placeholder="Enter Category Name">
                            </div>
                            <div class="col-6 mb-20">
                                <label for="editcountry" class="form-label fw-semibold text-primary-light text-sm mb-8">Status </label>
                                <select class="form-control radius-8 form-select" name="status" id="editstatus">
...
<script>
    function getCategory(id){
        ...
        success: function(res){
            ...
            var status  = JSONObject.statuss;
            
            $("#upid").val(id);
            $("#editcategory").val(name);
            $("#editstatus").val(status.toString());
        },
    });
    }
</script>
...
<script>
    ...
    function getSubcats(id){
        ...
        if(cat_id != ''){
            $.get('/admin/subcategories/' + cat_id, function(data){
                var html = '<option value="">-- Select Subcategory --</option>';
                data.forEach(function(sub){
                    html += '<option value="'+sub.id+'">'+sub.category+'</option>';
                });
