            ...
            <div class="table-responsive scroll-sm">
                <table class="table bordered-table sm-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>01</td>
                            <td class="text-center">{{$allCatVal->category}}</td>
                            <td class="text-center">
                                @if($allCatVal->children->count())
                                    <ul class="mb-0">
                                    @foreach($allCatVal->children as $child)
                            ...
                            <td>
                                <div class="form-switch switch-primary d-flex align-items-center justify-content-center">
                                    <input class="form-check-input" type="checkbox" role="switch" @if($allCatVal->status==1) checked @endif>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    <a href="#" onclick="return getCategory({{$allCatVal->id}})" class="bg-success-100 text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" data-bs-toggle="modal" data-bs-target="#exampleModalEdit">
                    ...
                    <form action="{{route('admin.sub_category')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-6 mb-20">
                                <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Select Category </label>
                                <select name="parent_id" class="form-control radius-8 form-select">
                            ...
                            <div class="col-6 mb-20">
                                <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Sub Category </label>
                                 <input type="text" class="form-control radius-8" id="sub_category" name="sub_category" value=""  placeholder="Enter Sub Category Name">
                            </div>
                            <div class="col-6 mb-20">
