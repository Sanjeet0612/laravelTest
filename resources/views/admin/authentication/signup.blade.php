        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <h4 class="mb-12">Vendor Sign Up to your Account</h4>
                ...
                <form action="{{route('vendor.register')}}" method="post">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="text" name="name" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username">
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                    ...
                    <div class="mt-32 text-center text-sm">
                        <p class="mb-0">Already have an account? <a  href="{{ route('vendor.login') }}" class="text-primary-600 fw-semibold">Sign In</a></p>
                    </div>
