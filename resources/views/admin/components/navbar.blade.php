        ...
        <div class="col-auto">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                @php
                    ...
                    $profile_img = $admin->profile_img ?? null;
                    $name = $admin->name ?? '';
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                        ...
                        <img src="{{asset('storage/'.$profile_img)}}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
                        @else
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            <div>
                                ...
                                <span class="text-secondary-light fw-medium text-sm">  {{$created_at}}</span><br>
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-danger d-flex align-items-center gap-3" href="{{ route('admin.admin_logout') }}">
